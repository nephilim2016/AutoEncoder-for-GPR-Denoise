...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep 10 21:37:08 2020
...
ProfileTargetGain=ProfileTargetGain+1e4*(np.random.random(ProfileTargetGain.shape)-0.5)
ProfileTargetGain[:,190:193]=ProfileTargetGain[:,190:193]+2e4*(np.random.random(ProfileTargetGain[:,190:193].shape)-0.5)
# 
ProfileTargetGain[:,90:93]=ProfileTargetGain[:,90:93]+1.8e4*(np.random.random(ProfileTargetGain[:,90:93].shape)-0.5)

ProfileTargetGain[:,100:103]=ProfileTargetGain[:,100:103]+1.5e4*(np.random.random(ProfileTargetGain[:,100:103].shape)-0.5)

ProfileTargetGain[:,150:153]=ProfileTargetGain[:,150:153]+2.1e4*(np.random.random(ProfileTargetGain[:,150:153].shape)-0.5)

ProfileTargetGain[:,160:163]=ProfileTargetGain[:,160:163]+1.8e4*(np.random.random(ProfileTargetGain[:,160:163].shape)-0.5)
...
pyplot.figure()
pyplot.imshow(ProfileClean,vmin=np.min(ProfileClean),vmax=np.max(ProfileClean),extent=(0,1,0.618,0),cmap=cm.seismic)
ax=pyplot.gca()
...
pyplot.savefig('Complex_.png',dpi=1000)
...
pyplot.figure()
pyplot.imshow(ProfileNoise,vmin=np.min(ProfileNoise),vmax=np.max(ProfileNoise)-2000,extent=(0,1,0.618,0),cmap=cm.seismic)
ax=pyplot.gca()
ax.set_xticks(np.linspace(0,1,6))
ax.set_xticklabels([0,1,2,3,4,5])
ax.set_yticks(np.linspace(0,0.618,8))
...
pyplot.xlabel('Scan (m)')
pyplot.ylabel('Time (ns)')
pyplot.savefig('ComplexNoise_.png',dpi=1000)
...
pyplot.figure()
pyplot.imshow(DenoiseResidual_Residual,vmin=np.min(DenoiseResidual_Residual),vmax=np.max(DenoiseResidual_Residual),extent=(0,1,0.618,0),cmap=cm.seismic)
ax=pyplot.gca()
ax.set_xticks(np.linspace(0,1,6))
ax.set_xticklabels([0,1,2,3,4,5])
ax.set_yticks(np.linspace(0,0.618,8))
...
pyplot.imshow(ProfileDenoise_Residual,vmin=np.min(ProfileDenoise_Residual),vmax=24249,extent=(0,1,0.618,0),cmap=cm.seismic)
ax=pyplot.gca()
ax.set_xticks(np.linspace(0,1,6))
ax.set_xticklabels([0,1,2,3,4,5])
ax.set_yticks(np.linspace(0,0.618,8))
...
pyplot.xlabel('Scan (m)')
pyplot.ylabel('Time (ns)')
pyplot.savefig('ComplexDenoise_.png',dpi=1000)
