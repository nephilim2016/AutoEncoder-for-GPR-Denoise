...
# -*- coding: utf-8 -*-
"""
Created on Sat Jul 18 15:18:15 2020
...
if __name__=='__main__':
    ...
    # Build Autoencoer kernel_size=7
    AutoEncoder=Build_AutoEncoder.BuildAutoEncoder(ImageShape=tuple(list(patch_size)+[1,]),filters=[16,32,64],kernel_size=[7,7,7],latent_dim=256)
    ...
    epochs=10
    save_path_name='./GaussNormalAutoEncoder400MB_iteration10_monitor_kernel7_windows3_[16,32,64]'
